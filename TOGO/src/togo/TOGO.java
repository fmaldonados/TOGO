...
public class TOGO {
    ...
    public static void main(String[] args) {
        ...
        nodo_g vertex3  =  new nodo_g("proveedor");// prueba de que no este nodo no se puede meter al grafo
        ...
        G.addVertex(vertex3);// este no se agregara y por eso se imprimira un mensaje
        if (G.isAdjacent(vertex, vertex2)) {
            ...
            System.out.println(cable2.toString());// aqui solo cambia el orden de los nodos pero es la misma arista
        }
